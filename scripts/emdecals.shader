textures/decals/emsoda
{
	qer_editorimage textures/decals/emsoda.tga
	qer_trans 0.3
	...
	{
		detail
		map textures/decals/emsoda.tga
		blendFunc filter
...
textures/decals/moddecallbyel
{
	...
	{
		detail
		map textures/decals/moddecallbyel.tga
		blendFunc filter
		//blendFunc GL_SRC_ALPHA GL_ONE // blendfunc add the alphamasked part only
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		rgbGen Vertex
...
textures/decals/emcommunism
{
	...
	{
		detail
		map textures/decals/communism.tga
		blendFunc filter
		//blendFunc GL_SRC_ALPHA GL_ONE // blendfunc add the alphamasked part only
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		rgbGen Vertex
...
textures/decals/emcommunism2
{
	...
	{
		detail
		map textures/decals/communism2.tga
		blendFunc filter
		//blendFunc GL_SRC_ALPHA GL_ONE // blendfunc add the alphamasked part only
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		rgbGen Vertex
...
textures/window/windowbrown
{
	...
	{
		detail
		map textures/window/windowbrown.tga
		//blendFunc filter
		//blendFunc GL_SRC_ALPHA GL_ONE // blendfunc add the alphamasked part only
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		rgbGen Vertex
...
textures/decals/communismposter
{
	...
	{
		detail
		map textures/decals/communismposter.tga
		blendFunc filter
		//blendFunc GL_SRC_ALPHA GL_ONE // blendfunc add the alphamasked part only
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		rgbGen Vertex
...
textures/decals/sewercover
{
	...
	{
		detail
		map textures/decals/emsewerc.tga
		blendFunc filter
		//blendFunc GL_SRC_ALPHA GL_ONE // blendfunc add the alphamasked part only
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		rgbGen Vertex
